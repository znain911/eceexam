...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>ECE Exam | Distance Learning Programme (DLP)</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0"><?php echo $examinfo->schedule_name;?> - Theory</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <!-- <li class="breadcrumb-item">Total Question: <?php echo $examinfo->no_of_question;?></li> -->
                                            <li class="breadcrumb-item">No of Theory Question: <?php echo $examinfo->no_of_question_theory;?></li>
                                            <li class="breadcrumb-item">Total Theory Mark: <?php echo $examinfo->total_mark_theory;?></li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card border border-primary">
                                            <div class="card-body border-bottom py-3">
                                                <h6 class="my-0 text-info float-left">Total Marks: <?php echo $examinfo->total_mark_theory;?></h6>
...
<input type="hidden" name="pass_mark" value="<?php echo $examinfo->pass_mark_theory;?>">
...
let fiveMinutes = 60 * <?php echo $examinfo->exam_time;?>;
