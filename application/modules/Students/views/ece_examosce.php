                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0"><?php echo $examinfo->schedule_name;?> - OSCE</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item">Total OSCE Question: <?php echo $examinfo->no_of_question_osce;?></li>
                                            <!-- <li class="breadcrumb-item">No of <?php echo $exmttl;?> Question: <?php echo $quesn;?></li> -->
                                            <li class="breadcrumb-item">Total OSCE Mark: <?php echo $examinfo->total_mark_osce;?></li>
...
tmp!=0||(tmp=time);
    ...
    //var timeleft = 60*<?php echo $exmtm;?>;
    var timeleft = 50*<?php echo $examinfo->exam_time;?>;
...
let fiveMinutes = 50 * <?php echo $examinfo->exam_time;?>;
		...
		let startWebcamRecord = async function () {
			try {
				...
				const options = {
					...
					videoBitsPerSecond: 64000, // Limit video bitrate to reduce size
				};
				...
				startTimer(fiveMinutes, display);
					...
					//alert(error.message);
					alert('To Proceed to exam you need to connect a camera to your device and reload');
					return;
				}
			}
		}
