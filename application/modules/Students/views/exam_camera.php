...
<html lang="en">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-5">
								...
								<button id="btn" class="btn btn-success" onclick="capture_web_snapshot()">Take picture to start exam</button>
                                <!-- <input type=button value="Take Snapshot" onClick="capture_web_snapshot()"> -->
                                <div style="height:30px; clear:both;"></div>
                                <a href="<?php echo base_url('students/makeexamece/').$examinfo->schedule_id.'/'.$qtype;?>" class="btn btn-warning waves-effect waves-light on"  style = "display: none"> Start Exam</a>
    ...
    function capture_web_snapshot() {
        Webcam.snap( function(site_url) {
            ...
            document.getElementById('preview').innerHTML = '<img style = "width: 80%" src="'+site_url+'"/>';
			if ($("#preview").has("img") ) {
				$(".on").show();
}
        } );
