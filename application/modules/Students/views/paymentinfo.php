                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
							...
							<div style="height:50px; clear: both;"></div>
								<?php if ($std_info->payment_status == 0) {?>		
                            	<h2>Please pay <?php echo $paymentdata->fee_amount;?></h2>
								<div style="height:20px; clear: both;"></div>
                            	<a href="<?php echo base_url('students/payment/pay');?>" class="btn btn-info btn-lg waves-effect waves-light" >Pay Now</a>
                            <?php }else{
                            	echo '<h2>Your payment has completed</h2>';
                            }?>
                            </div>
							<div class="col-6">
                                <img src="<?php echo base_url();?>assets/images/SSLCommerz-Pay-With-logo-All-Size-05.png" width="90%" >
                            </div>
