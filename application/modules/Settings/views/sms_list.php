...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>SMS List | Distance Learning Programme (DLP)</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">SMS List</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo base_url('admin');?>">Dashboard</a></li>
                                            <li class="breadcrumb-item active">SMS List</li>
                                        </ol>
                                    </div>
                                        ...
                                        <div class="table-responsive mt-3">
                                            ...
                                            <table id="example" class="table table-centered" data-page-length="10" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $i=1; foreach ($get_sms as $lst) {?>
                                                    
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $lst->sms_place; ?></td>
                                                        <td><?php echo $lst->sms_text; ?></td>
                                                        <td><?php echo $lst->email_text; ?></td>
                                                        <td>
                                                        	<a href="<?php echo base_url('settings/editsms/').$lst->id; ?>" class="text-info" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" style="float: left;"><i class=" ri-edit-box-fill font-size-18"></i></a>
                                                        </td>
