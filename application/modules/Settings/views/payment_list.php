...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Payment List | Distance Learning Programme (DLP)</title>
                                        ...
                                        <div class="table-responsive mt-3">
                                            ...
                                            <table id="example" class="table table-centered" data-page-length="10" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $i=1; foreach ($get_paymnt as $lst) {?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $lst->onpay_type; ?></td>
														<td><?php echo $lst->onpay_transaction_id; ?></td>
														<td><?php echo $lst->onpay_transaction_amount; ?></td>
														<td><?php echo $lst->onpay_transaction_status; ?></td>


                                                        <td><?php echo date("d-m-Y",strtotime($lst->onpay_transaction_date)); ?></td>
