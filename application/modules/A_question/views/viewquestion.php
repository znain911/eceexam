                                                        ...
                                                        <div>
                                                            <select class="form-control" name="module" id="module" required>
                                                                ...
                                                                <?php foreach ($mdllist as $mdl) {?>
                                                                    <option value="<?php echo $mdl->module_id;?>" <?php if($qsn_data->qa_module == $mdl->module_id){ echo 'selected'; } ?> ><?php echo $mdl->module_name;?></option>
                                                                <?php }?>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-check mb-1">
                                                                    <input class="form-check-input" type="radio" name="ans<?php echo $i;?>" id="<?php echo $qa->qa_id;?>1" value="1" <?php if ($qa->qa_ans == 1){ echo 'checked'; } ?> >
                                                                    <label class="form-check-label" for="<?php echo $qa->qa_id;?>1">
                                                                        True
                                                                    </label>
                                                                </div>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio" name="ans<?php echo $i;?>" id="<?php echo $qa->qa_id;?>2" value="0" <?php if ($qa->qa_ans == 0){ echo 'checked'; } ?>>
                                                                    <label class="form-check-label" for="<?php echo $qa->qa_id;?>2">
                                                                        False
                                                                    </label>
                                                                </div>
